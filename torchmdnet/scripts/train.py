...
def get_args():
    ...
    parser.add_argument('--lr-metric', type=str, default='val_loss', choices=['train_loss', 'val_loss'],
                        help='Metric to monitor when deciding whether to reduce learning rate')
    parser.add_argument('--lr-min', type=float, default=1e-6, help='Minimum learning rate before early stop')
    parser.add_argument('--lr-factor', type=float, default=0.8,
                        help='Factor by which to multiply the learning rate when the metric stops improving')
    ...
    parser.add_argument('--reset-trainer', type=bool, default=False,
                        help='Reset training metrics (e.g. early stopping, lr) when loading a model checkpoint')
    ...
    parser.add_argument('--ema-alpha-neg-dy', type=float, default=1.0,
    ...
    parser.add_argument('--log-dir', '-l', default='../', help='log file')
    ...
    # dataset specific
    parser.add_argument('--dataset', default='Custom', type=str, choices=datasets.__all__,
    ...
    parser.add_argument('--dataset-arg', default=None, type=str,
                        help='Additional dataset arguments, e.g. target property for QM9 or molecule for MD17. Need to be specified in JSON format i.e. \'{"molecules": "aspirin,benzene"}\'')
    parser.add_argument('--coord-files', default='../datasets/coord*', type=str, help='Custom coordinate files glob')
    parser.add_argument('--embed-files', default='../datasets/embed*', type=str, help='Custom embedding files glob')
    parser.add_argument('--energy-files', default='../datasets/energy*', type=str, help='Custom energy files glob')
    parser.add_argument('--force-files', default='../datasets/force*', type=str, help='Custom force files glob')
    parser.add_argument('--y-weight', default=1.0, type=float, help='Weighting factor for y label in the loss function')
    parser.add_argument('--neg-dy-weight', default=1.0, type=float,
                        help='Weighting factor for neg_dy label in the loss function')

    # model architecture
    parser.add_argument('--model', type=str, default='graph-network', choices=models.__all__,
    ...
    # TensorNet specific
    parser.add_argument('--equivariance-invariance-group', type=str, default='O(3)',
                        help='Equivariance and invariance group of TensorNet')
    ...
    parser.add_argument('--max-num-neighbors', type=int, default=70,
    ...
    parser.add_argument('--wandb-resume-from-id', default=None, type=str,
                        help='Resume a wandb run from a given run id. The id can be retrieved from the wandb dashboard')
